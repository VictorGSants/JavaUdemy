    ...
    public static void main(String[] args) throws ParseException {
        ...
        */
        ...
        if (!checkOut.after(checkIn)){  // .after testa se uma data é depois da outra
            ...
            String error = reservation.UpadteDates(checkIn, checkOut); // metodos responsaveis por atualizar as datas

            if (error != null){ // se o valor "Error" for diferente de nulo significa que houve erros e retorna o erro
